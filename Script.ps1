# Pulled from: https://github.com/johnthebrit/DevOpsMC/blob/main/Part02MasterGit/Script.ps1
...
#The reason for gitgraph first is so you cna get the commit hashes you need ex 71989c0..e94ac00
...
#Can also run git diff --staged and get the same results b/c the current example has staged content not yet commited to the repo
git diff
